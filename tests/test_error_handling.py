...
# GPU tests (shutdown ordering, diagnostics, arch-specific) moved to test_gpu_hip.py

# ===========================================================================
# 4. Source Guard Extended (CPU only)
# ===========================================================================
...
# Arch-specific GPU tests moved to test_gpu_hip.py
